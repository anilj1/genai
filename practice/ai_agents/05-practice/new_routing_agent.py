...
def new_support_agent(state: DeptRouterState) -> dict:
    prompt = f"Support team: we will help you with your support request: {state['inquiry']}"
...
def build_routing_graph():
    ...
    graph.add_node("support_agent", new_support_agent)
...
if __name__ == "__main__":
    ...
    state = DeptRouterState(
        inquiry="Can you help me reset my password?",
        department="",
        response=""
    )
